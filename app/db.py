...
REGIONS = {
    "ru": {"name": "Россия",     "cur": "RUB", "sym": "\u20bd"},
    "kz": {"name": "Казахстан",  "cur": "KZT", "sym": "\u20b8"},
    "ua": {"name": "Украина",    "cur": "UAH", "sym": "\u20b4"},
    "tr": {"name": "Турция",     "cur": "USD", "sym": "$"},
    "us": {"name": "США",        "cur": "USD", "sym": "$"},
    "de": {"name": "Германия",   "cur": "EUR", "sym": "\u20ac"},
}


def region(cc):
    return REGIONS.get(cc) or REGIONS[HOME_CC]
